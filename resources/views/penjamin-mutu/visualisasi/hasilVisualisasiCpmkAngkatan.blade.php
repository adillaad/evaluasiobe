...
@section('content')
    ...
    @endif
    <h3 id="title" data-course="{{ $completeCourseFormat }}" class="px-4 pb-4 fw-bold text-center">Hasil Visualisasi CPMK
        {{ $completeCourseFormat }} Angkatan {{ $angkatan }}</h3>
    {{-- {{dd($allAngkatan)}} --}}
                            ...
                            <div class="col-sm-6">
                                <div class="card mt-3">
                                    <div class="card-body">
                                        ...
                                        <ol>
                                            <li>
                                                <h6 id="angkatanData" class="card-subtitle mt-2 text-black">Angkatan :
                                                    {{ $angkatan }}
                                                </h6>
                                            </li>
                                            <li>
    ...
    <script>
        $(document).ready(function() {
            $('#angkatan').on('change', function() {
                ...
                $.ajax({
                    url: "{{ route($currentPrefix . 'visualisasi.getAllNpmByAngkatan') }}", // route untuk kirim ke kontroler
                    method: 'GET',
                    data: {
                        angkatan: angkatan,
                        prodi: prodi
