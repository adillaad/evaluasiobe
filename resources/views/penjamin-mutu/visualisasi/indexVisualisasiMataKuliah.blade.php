    ...
    {{-- <script>
        $(document).ready(function() {
            ...
            $('#universitas').on('change', function() {
                ...
                $.ajax({
                    url: "{{ route($currentPrefix . 'visualisasi.getProdiByUniversitas') }}", // route untuk kirim ke kontroler
                    method: 'GET',
                    data: {
    ...
    <script>
        $(document).ready(function() {
            ...
            @if ($userOtoritas == 'Dosen' ||
                    $userOtoritas == 'Kepala Program Studi' ||
                    $userOtoritas == 'Penjamin Mutu Program Studi')
