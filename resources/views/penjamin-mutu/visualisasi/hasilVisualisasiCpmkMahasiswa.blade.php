...
@section('content')
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="card mt-3">
                                    <div class="card-body">
                                        ...
                                        <ol>
                                            <li>
                                                <h6 id="nama" class="card-subtitle mt-2 text-black">Nama : {{ $nama }}</h6>
                                            </li>
                                            <li>
                                                <h6 id="npmData" class="card-subtitle mt-2 text-black">NPM : {{ $npm }} </h6>
                                            </li>
                                            <li>
                                                <h6 id="angkatan" class="card-subtitle mt-2 text-black">Angkatan : {{ $angkatan }}
                                                </h6>
                                            </li>
                                            <li>
    ...
    <script>
        $(document).ready(function() {
            $('#npm').on('change', function() {
                ...
                $.ajax({
                    url: "{{ route($currentPrefix . 'visualisasi.getNamaByNpm') }}", // route untuk kirim ke kontroler
                    method: 'GET',
                    data: {
                        npm: npm
                    },
    ...
    <script>
        ...
        console.log(@json($completeCourseFormat));
        ...
        document.getElementById('btnPrintPdf').addEventListener('click', function() {
            ...
            let universitas = document.getElementById("universitas").textContent.trim().replace(
                /^Universitas[:\s]*/, "");

            fetch("{{ route($currentPrefix . 'visualisasi.generate-pdfVisualCPMKMahasiswa') }}", {
                    method: "POST",
                    headers: {
                ...
                .then(blob => {
                    ...
                    a.href = url;
                    a.download =
                        `Laporan Visualisasi CPMK Mahasiswa - ${nama}.pdf`;
