        ...
        <div class="card modern-card mb-4">
            <div class="card-body p-4">
                <div class="mb-4">
                    ...
                    <p class="text-muted small mb-0">Silahkan pilih data angkatan dan mata kuliah untuk menampilkan visualisasi OBE.</p>
                </div>
        ...
        $(document).ready(function() {
            ...
            function parseOptionsFromHtml(html) {
                ...
                $temp.find('option').each(function() {
                    ...
                    if (val && val !== '' && !text.toLowerCase().includes('pilih') && !text.toLowerCase().includes('memuat')) {
            ...
            $('#angkatanDisplayInput').on('focus click', function() {
                if (!angkatanOptionsData.length) return;
                var currentVal = $('#angkatanForm').val();
            ...
            $('#hasilVisual').on('submit', function(event) {
                ...
                if (!course || !angkatan || !prodi) {
                    alert('Mohon lengkapi pilihan Angkatan dan Mata Kuliah!');
                    return;
                }
