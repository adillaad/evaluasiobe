        ...
        <div class="card modern-card mb-4">
            <div class="card-body p-4">
                <div class="mb-4">
                    ...
                    <p class="text-muted small mb-0">Silahkan pilih data angkatan untuk menampilkan visualisasi OBE.</p>
                </div>
    ...
    <script>
        $(document).ready(function() {
                ...
                if (ketercapaianCplPerTahun && Object.keys(ketercapaianCplPerTahun).length > 0) {
                    ...
                    $.each(yearsList, function(idx, yr) {
                        ...
                        if (hasDataYr && ketercapaianCplYearlyAvg[yr] !== null && ketercapaianCplYearlyAvg[yr] !== undefined) {
                            ...
                            footerHtml += '<th class="text-center text-primary fw-bold interactive-year-tf" data-year="' + yr + '" style="color: #1F3BB3 !important; cursor: pointer;" title="Klik tahun ' + yr + '">' + avgPctYr + '%</th>';
                        } else {
            ...
            $('#selectPemetaanCpl').on('change', function() {
                ...
                $.ajax({
                    url: "{{ route($currentPrefix . 'getPemetaanCpl') }}",
                    method: 'GET',
                    data: {
                        idCpl: idCpl,
                    },
