        ...
        <div class="card modern-card mb-4">
            <div class="card-body p-4">
                <div class="mb-4">
                    ...
                    <p class="text-muted small mb-0">Silahkan pilih data angkatan dan mahasiswa untuk menampilkan visualisasi OBE.</p>
                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            function onAngkatanSelected(angkatan, autoOpenNpm) {
                ...
                $.ajax({
                    url: "{{ route($currentPrefix . 'getNpmByAngkatan') }}",
                    method: 'GET',
                    data: {
                        angkatan: angkatan,
            ...
            function renderVisualisasiData(response) {
                ...
                $("#btnPrintPdf").off("click").on("click", function() {
                    ...
                    form.method = "POST";
                    form.action = "{{ route($currentPrefix . 'generate-pdfVisualMahasiswa') }}";
                    form.target = "_blank";
